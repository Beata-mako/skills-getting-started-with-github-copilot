document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities(forceFresh = false) {
    try {
      const activitiesUrl = forceFresh ? `/activities?ts=${Date.now()}` : "/activities";
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        // Participants list (pretty, with fallback if none)
